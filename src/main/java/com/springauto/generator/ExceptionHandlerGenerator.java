...
public class ExceptionHandlerGenerator {
    ...
    public Map<String, String> generate(OpenApiSpec spec, String basePackage) {
        ...
        files.put("src/main/java/" + pkgPath + "/exception/GlobalExceptionHandler.java",
                generateHandler(basePackage));
        return files;
    }

    private String generateHandler(String pkg) {
        return """
                package %s.exception;

                import %s.dto.ApiException;
                import %s.dto.ApiResponse;
                import %s.dto.ErrorDetail;
